...
const crearProveedores = async () => {
  ...
  if (
    ...
    // const expresionNombreProv = /^([0-9]*[a-z]*)\[a-z]*\.[a-z]*$/
    // const expresionNit = /^([0-9]*[a-z]*)/
